...
export function PTYSSPrefacturaEditModal({ open, onOpenChange, invoice, onClose, onEditSuccess }: {
  open: boolean,
  ...
  const handleSave = async () => {
    ...
    setIsSaving(true)
    try {
      // Calcular el nuevo total incluyendo servicios adicionales
              ...
              {servicesLoading ? (
                ...
                <>
                  ...
                  >
                    ...
                    {services.filter(s => !form.additionalServices.some(a => a.serviceId === s._id)).map(service => (
