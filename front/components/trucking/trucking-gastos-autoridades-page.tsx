...
import { sumAutoridadesBLAmount, totalAutoridadesBL } from "@/lib/trucking-autoridades-totals";
...
export function TruckingGastosAutoridadesPage() {
  ...
  // Total alineado con el XML (NOTF sumado por línea con order + notf; SEAL por contenedor)
